    ...
    drag:
        ...
        frame:
            ...
            has vbox:
                ...
                use ASInterfaceTitlebar("Настройки Celeste", onClose=Hide("CelesteSettings"))
                ...
                vbox:
                    ...
                    hbox:
                        ...
                        vbox:
                            ...
                            label "Режим отображения фона"

                            vbox:
                                style_prefix "ASInterfaceRadio"

                                textbutton "Растянуть" action Function(celeste._update_wallpaper_display_mode, "contain"):
                                    selected celeste._wall_display_mode == "contain"
                                textbutton "По центру" action Function(celeste._update_wallpaper_display_mode, "cover"):
                                    selected celeste._wall_display_mode == "cover"
                                textbutton "Заполнение" action Function(celeste._update_wallpaper_display_mode, "fill"):
