...
screen ASSysInfoView():
    ...
    drag:
        ...
        frame:
            ...
            has vbox:
                use ASInterfaceTitlebar(_("О системе [AS_SYS_INFO[NAME]]"), onClose=[Hide("ASSysInfoView"), ASSysInfo.terminate])
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        text "{=ASSysInfoProperty_text_bold}Сделано для Ren'Py{/} [renpy.version_only]":
                            style "ASSysInfoProperty_text"
                        null height 24
                        text _("© 2018-2021 Project Alice и UnscriptedVN team.\n[AS_SYS_INFO[NAME]] является свободным программным обеспечением с открытым исходным кодом, лицензированным по условиям двухпунктной лицензии BSD."):
